...
public class  CaraGabungActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cara_gabung);

        //buka webnya
        webView = findViewById(R.id.caragabung_webview);
        webView.setWebViewClient(new WebViewClient());
        webView.loadUrl("https://www.yuk-kunjungi.com/cara-gabung/");
