...
public class  BisnisProdukActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bisnis_produk);

        //buka webnya
        webView = findViewById(R.id.bisnisproduk_webview);
        webView.setWebViewClient(new WebViewClient());
        webView.loadUrl("https://www.yuk-kunjungi.com/category/bisnis-produk/");
