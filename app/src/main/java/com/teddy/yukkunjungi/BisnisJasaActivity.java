...
public class  BisnisJasaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bisnis_jasa);

        //buka webnya
        webView = findViewById(R.id.bisnisjasa_webview);
        webView.setWebViewClient(new WebViewClient());
        webView.loadUrl("https://www.yuk-kunjungi.com/category/bisnis-jasa/");
