...
public class  InputUsahaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_input_usaha);

        //buka webnya
        webView = findViewById(R.id.inputusaha_webview);
        webView.setWebViewClient(new WebViewClient());
        webView.loadUrl("https://www.yuk-kunjungi.com/formulir-isian-untuk-dipromosikan-di-yuk-kunjungi/");
    ...
    public void ClickContoh (View view){
        ...
        MainActivity.redirectActivity(this,ContohPostActivity.class);
    }
